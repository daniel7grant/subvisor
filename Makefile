...
build/main: build src/main.c build/config/config.o build/config/baseconfig.o build/config/programconfig.o build/logger/logger.o
	$(CC) $(CFLAGS) -o build/main src/main.c build/config/config.o build/config/baseconfig.o build/config/programconfig.o build/logger/logger.o
